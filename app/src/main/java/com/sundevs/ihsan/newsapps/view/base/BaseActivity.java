package com.sundevs.ihsan.newsapps.view.base;
...
import com.sundevs.ihsan.newsapps.BaseView;
import com.sundevs.ihsan.newsapps.NewsApp;
...
public abstract class BaseActivity extends AppCompatActivity implements BaseView {
    ...
    protected void startBeaconService() {
        NewsApp homyCare = (NewsApp) getApplication();
